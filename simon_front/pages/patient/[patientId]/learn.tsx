    ...
    return container(
        <>
                ...
                <Card
                    ...
                    content={
                        <div className="relative flex flex-col gap-2 w-full">
                            <p>Probablemente ya habrá pasado un tiempo desde que comenzaste a sentir que algo no iba bien; lo que en principio sólo eran pequeños malos momentos que podías controlar, se han ido haciendo más presentes en tu día a día hasta que has visto que te desbordaban.  </p>
                            <p>Es posible que ya en ese momento te rondara por la cabeza la idea de consultar con un psicólogo, un psiquiatra o “algo de eso”, pero decidiste esperar para ver si se pasaba y te encontrabas mejor. </p>
                            <p>Pero pasaba el tiempo y veías que la cosa seguía igual, hasta que hace poco decidiste que esto no podía seguir así, y te decidiste a llamar a ese psicólogo que te habían recomendado o que habías encontrado tras horas de búsqueda. Bien, ya tienes tu primera cita. ¿Y ahora qué? Con esta pequeña guía espero poder responder alguna de las dudas que probablemente tendrás en este momento y hacer que tu primera visita a la consulta sea lo más satisfactoria y provechosa para ti. Esta guía está elaborada en base a las dudas que han tenido otras personas que han estado en el mismo punto en el que te encuentras tú ahora. Espero que te sea de utilidad.</p>
                            <p className="font-semibold">“La psicoterapia es un tratamiento, ejercido por un profesional autorizado que utiliza medios psicológicos para ayudar a resolver problemas humanos en el contexto de una relación profesional”</p>
                            <p>La terapia psicológica está dirigida principalmente a dos grupos de personas: Por un lado, está orientada a aquellas personas que presentan un trastorno psicológico (por ejemplo, ansiedad, depresión, fobias, anorexia, bulimia, adicciones, etc.) </p>
                            <p>En estos casos, el objetivo principal de la terapia será, en primer lugar, el control de los síntomas que se presenten y el aprendizaje de estrategias y habilidades que prevengan la reaparición de los síntomas. Por otro lado, la psicoterapia también está orientada al crecimiento personal y a la solución de problemas. No es necesario presentar un trastorno psicológico para poder beneficiarse de la ayuda psicoterapéutica.</p>
                        </div>
                    }
                />
                <Card
            ...
            <Image
                ...
                height={512}
            />
            <p className="px-6 text-md text-[#444]">Esto es todo lo que estás haciendo para cuidar de ti y de tu planta</p>
